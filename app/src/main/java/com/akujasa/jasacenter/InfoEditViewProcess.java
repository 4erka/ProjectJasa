...
public class InfoEditViewProcess extends AsyncTask{
    private String nama;
   ...
   private EditText tvNama;
    ...
    public InfoEditViewProcess(Context context, EditText tvNama, EditText tvEmail, EditText tvAlamat, EditText tvNohp){
